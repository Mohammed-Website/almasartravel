        ...
        if (messageBar.value.trim() !== "") {
            ...
            let botResponse = `
                <div class="chat response">
                    <img src="https://mohammed-website.github.io/almasartravel/%D9%85%D9%83%D8%AA%D8%A8-%D8%B3%D9%8A%D8%A7%D8%AD%D9%8A/%D9%85%D9%83%D8%AA%D8%A8-%D8%B3%D9%8A%D8%A7%D8%AD%D9%8A-%D8%A8%D8%AD%D8%B1%D9%8A%D9%86%D9%8A.png">
                    <span class="new">...</span>
                </div>
            `;
...
const sectionData = [
    {
        title: 'عروض طرابزون & اسطنبول',
        image_1: ['عروض-شركة-المسار/عروض-طرابزون-اسطنبول/عرض-طرابزون-اسطنبول-1.jpg', 'عرض طرابزون & اسطنبول - 8 أيام'],
        image_2: ['عروض-شركة-المسار/عروض-طرابزون-اسطنبول/عرض-طرابزون-اسطنبول-2.jpg', 'عرض طرابزون & اسطنبول - 9 أيام'],
        image_3: ['عروض-شركة-المسار/عروض-طرابزون-اسطنبول/عرض-طرابزون-اسطنبول-3.jpg', 'عرض طرابزون & اسطنبول - 10 أيام'],
    },

    {
        title: 'عروض طرابزون & ريزا',
        image_1: ['عروض-شركة-المسار/عروض-طرابزون-ريزا/عرض-طرابزون-ريزا-1.jpg', 'عرض طرابزون & ريزا - اسبوع واحد'],
        image_2: ['عروض-شركة-المسار/عروض-طرابزون-ريزا/عرض-طرابزون-ريزا-2.jpg', 'عرض طرابزون & اسطنبول & ريزا'],
    },

    {
        title: 'عروض طرابزون',
        image_1: ['عروض-شركة-المسار/عروض-طرابزون/عرض-طرابزون-1.jpg', 'عرض طرابزون - اسبوع واحد'],
        image_2: ['عروض-شركة-المسار/عروض-طرابزون/عرض-طرابزون-2.jpg', 'عرض طرابزون - اسبوع واحد'],
        image_3: ['عروض-شركة-المسار/عروض-طرابزون/عرض-طرابزون-3.jpg', 'عرض طرابزون - 8 أيام'],
    },

    {
        title: 'عروض اسطنبول',
        image_1: ['عروض-شركة-المسار/عروض-اسطنبول/عرض-اسطنبول-1.jpg', 'عرض اسطنبول - 7 أيام'],
    },
    
    {
        title: 'عروض سوتشي',
        image_1: ['عروض-شركة-المسار/عروض-سوتشي/عرض-سوتشي-1.jpg', 'عرض سوتشي - اسبوع واحد'],
        image_2: ['عروض-شركة-المسار/عروض-سوتشي/عرض-سوتشي-2.jpg', 'عرض سوتشي - اسبوع واحد'],
        image_3: ['عروض-شركة-المسار/عروض-سوتشي/عرض-سوتشي-3.jpg', 'عرض سوتشي - اسبوع واحد'],
    },
];
...
function openFullScreenImage(src, text) {
    ...
    whatsappButton.href = `https://wa.me/+97332204500?text=طلب%20حجز%20هذا%20العرض:%0A%0Ahttps://mohammed-website.github.io/almasartravel/${encodeURIComponent(src)}`;
...
let mughader_commentsArray = [
    ...
    },
    {
        ...
        comment: "شكرا شركة المسار على اتقانكم  بالعمل وعلى خدمتكم الجميله بارك الله فيكم وفي جهودكم الى الاعلى بإذن",
        stars: 5
    },
    {
        profileImage: "https://mughader.com/مكتب-للسفر-والسياحة/مكتب-للسفر-والسياحة-3.png",
        personName: "ناصر الهزاع",
        comment: "اشكر طاقم شركة المسار على تعاملهم معي يستاهلو كل خير ♥️♥️",
        stars: 5
    },
    {
        profileLetter: "F",
    ...
    },
    {
        ...
        comment: "نشكر شركة المسار على جهوده وتمنى له دائم التوفيق و والــــنــــجـــــاح",
        stars: 5
    },
    {
        profileLetter: "H",
        personName: "Hala Abdullah",
        comment: "من افضل واحسن الي تعاملت معهم للامانة ولا غلطة والاسعار حلوه جدا ومعقولة مرا شككككرا  شركة المسار للسياحة 💛🙏🏻",
        stars: 5
    },
    {
        profileLetter: "س",
        personName: "سامي الموسى",
        comment: "صراحه مجهود يشكر عليه من شركة المسار للسفر والسياحة ومن افضل الشركات الي حريصه علئ ادق التفاصيل شركه تلبي جميع احتيجاتك وعن تجربه اتكلم صراحه تعاملهم جدا راقي بجميع الاماكن والاوقات ❤️❤️",
        stars: 5
    },
];
...
function mughader_generateComments(comments) {
    ...
    comments.forEach(({ profileLetter, profileImage, personName, comment, stars }, index) => {
        ...
        if (profileImage) {
            ...
            img.alt = `مكتب سياحي - شركة المسار`;
            img.title = `مكتب سياحي - شركة المسار`;
...
openWhatsAppNumber = function () {
    ...
    const whatsappNumber = "+97332204500";
